    ...
    return (
        <div className='text-left'>
            <div className='text-left min-h-screen m-2'>
                ...
                <p>The time2off.com website located at time2off.com is a copyrighted work belonging to time2off. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
                ...
                <p>Email: chris_time2off@time2off.com</p>
